                  ...
                  <tr key={i} className="border-t border-zinc-800">
                    ...
                    <td className="relative">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          atualizar(i, "mostrarSenha", !l.mostrarSenha)
                        }
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-elite"
                      >
                        {l.mostrarSenha ? "🙈" : "👁️"}
                      </button>
                    </td>
                    ...
                    <td className={lucro > 0 ? "text-elite" : "text-red-500"}>
                      {moeda(lucro)}
                    </td>
